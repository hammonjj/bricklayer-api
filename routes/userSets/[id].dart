...
Future<Response> onRequest(RequestContext context, String id) async {
  switch (context.request.method) {
    ...
    case HttpMethod.delete:
      return _deleteUserSetById(context, UuidValue.fromString(id));
    default:
...
Future<Response> _deleteUserSetById(RequestContext context, UuidValue setId) async {
  final user = context.read<SessionUser>();
  final userSetsService = context.read<UserSetService>();

  await userSetsService.deleteUserSet(setId, user.id);
